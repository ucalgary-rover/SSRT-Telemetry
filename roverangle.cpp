...
qreal RoverAngle::x_angle() const
{
    return m_x_angle;
}
...
qreal RoverAngle::y_angle() const
{
    return m_y_angle;
}
...
qreal RoverAngle::danger_level_x() const
{
    return m_danger_level_x;
}

qreal RoverAngle::danger_level_y() const
{
    return m_danger_level_y;
}
...
void RoverAngle::monitorData()
{
    while(m_stream_running) {
        ...
        qDebug("Current x danger: %i, current y danger: %i", x_danger(), y_danger());
...
bool RoverAngle::x_danger() const
{
    return m_x_danger;
}

bool RoverAngle::y_danger() const
{
    return m_y_danger;
}
