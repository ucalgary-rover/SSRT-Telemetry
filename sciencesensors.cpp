...
qreal ScienceSensors::decay_coeff() const
{
...
qreal ScienceSensors::half_life() const
{
    return m_half_life;
}
...
qreal ScienceSensors::total_energy() const
{
...
qreal ScienceSensors::uncertainty() const
{
...
qreal ScienceSensors::ozone_ppm() const
{
    return m_ozone_ppm;
}
...
qreal ScienceSensors::h2_ppm() const
{
    return m_h2_ppm;
}
...
qreal ScienceSensors::atomic_radius() const
{
    return m_atomic_radius;
}
...
qreal ScienceSensors::radioactivity() const
{
