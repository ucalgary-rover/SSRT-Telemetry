...
void ScienceSensors::setH21PPM(qreal newH2_1_ppm) {
  if (qFuzzyCompare(m_h2_1_ppm, newH2_1_ppm))
    return;
  m_h2_1_ppm = newH2_1_ppm;
  emit h21PPMChanged();
}

qreal ScienceSensors::h2_2_ppm() const { return m_h2_2_ppm; }

void ScienceSensors::setH22PPM(qreal newH2_2_ppm) {
  if (qFuzzyCompare(m_h2_2_ppm, newH2_2_ppm))
    return;
  m_h2_2_ppm = newH2_2_ppm;
  emit h22PPMChanged();
}
